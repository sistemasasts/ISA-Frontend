...
class SEPlanesAccionVer extends Component {
    ...
    constructor() {
        ...
        this.confirmarFinalizarRevision = this.confirmarFinalizarRevision.bind(this);
    ...
    async respuestaConfirmacion(identificador) {
        ...
        switch (identificador) {
            case 'finalizarProceso':
                await SolicitudEnsayoService.finalizarRevisionPlanesAccion(this.crearObjSolicitud());
                this.growl.show({ severity: 'success', detail: 'Planes de acción revisados con éxito.' });
                setTimeout(() => {
    ...
    confirmarFinalizarRevision() {
        if (this.planesAccionTodosCumplidos()) {
            this.growl.show({ severity: 'error', detail: 'Debe marcar el cumplimiento de todos los planes de acción.' });
            return false;
        }
        this.setState({ mostrarConfirmacion: true, contenidoConfirmacion: '¿Está seguro de finalizar la revisión de los planes de acción?', identificadorConfirmacion: 'finalizarProceso' });
    }
 ...
 */
    ...
    planesAccionTodosCumplidos() {
        const cumplidosNo = _.filter(this.state.planesAccion, (o) => { return o.cumplido === null });        
            ...
            <div className="card card-w-title">
                ...
                <div className='p-col-12 p-lg-12 boton-opcion' >
                    {this.state.id > 0 && this.state.estado === ESTADO &&
                        < div >
                            <Button className="p-button" label="FINALIZAR REVISIÓN" onClick={this.confirmarFinalizarRevision} />
