...
class PlantaPrincipal extends Component {
    ...
    async componentDidMount() {
        const solicitudes_data = await SolicitudPruebasProcesoService.listarAsignadas('PRODUCCION');
    ...
    render() {
        ...
        return (
            <div className="card card-w-title">
                ...
                <h3><strong>SOLICITUD DE PRUEBAS EN PROCESO PLANTA</strong></h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(PlantaPrincipal);