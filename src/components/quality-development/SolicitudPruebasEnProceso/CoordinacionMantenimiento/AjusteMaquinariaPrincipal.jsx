...
class AjusteMaquinariaPrincipal extends Component {
    ...
    async refrescar() {
        const solicitudes_data = await SolicitudPruebasProcesoService.listarAsignadas('AJUSTE_MAQUINARIA');
        this.setState({ solicitudes: solicitudes_data });
    }

    redirigirSolicitudEdicion(idSolcicitud) {
        history.push(`/quality-development_solicitudpp_ajuste_maquinaria_ver/${idSolcicitud}`);
    }
    ...
    render() {
        return (
            <div className="card card-w-title">
                ...
                <h3><strong>SOLICITUD AJUSTE DE MAQUINARIA MANTENIMIENTO</strong></h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(AjusteMaquinariaPrincipal);