...
class VerResponderSPP extends Component {
    ...
    async responderSolicitud() {
        ...
        await SolicitudPruebasProcesoService.responderSolicitud(this.crearObjSolicitud());
                ...
                {this.state.id > 0 &&
                    <div className='p-grid p-grid-responsive p-fluid'>
                        ...
                        <div className='p-col-12 p-lg-12'>
                            <Adjuntos solicitud={this.props.match.params.idSolicitud} orden={"RESPONDER_SOLICITUD"} controles={this.state.mostrarControles} estado={ESTADO} tipo={TIPO_SOLICITUD} />
