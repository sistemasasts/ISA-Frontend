...
class ReasignarResponsablePlanta extends Component {
    ...
    async refrescar() {
        const solicitudes_data = await SolicitudPruebasProcesoService.listarPorReasignarResponsable('PRODUCCION');
    ...
    render() {
        ...
        return (
            <div className="card card-w-title">
                ...
                <h3><strong>REASIGNACIÓN SOLICITUD PRODUCCIÓN</strong></h3>
                ...
                <DataTable style={{ marginTop: '5px' }} value={this.state.solicitudes} paginator={true} rows={15} responsive={true} scrollable={true}
                    ...
                    <Column field='usuarioGestionPlanta' header="Usuario Responsable" sortable style={{ textAlign: 'center', width: '12em' }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(ReasignarResponsablePlanta);