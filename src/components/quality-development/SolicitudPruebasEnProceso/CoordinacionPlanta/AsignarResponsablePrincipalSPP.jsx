...
class AsignarResponsablePrincipalSPP extends Component {
    ...
    async componentDidMount() {
        const solicitudes_data = await SolicitudPruebasProcesoService.listarPorAsignarResponsableCM('PRODUCCION');
    ...
    render() {
        ...
        return (
            <div className="card card-w-title">
                ...
                <h3><strong>SOLICITUD DE PRUEBAS EN PROCESO ASIGNACIÓN RESPONSABLE PRODUCCIÓN</strong></h3>
