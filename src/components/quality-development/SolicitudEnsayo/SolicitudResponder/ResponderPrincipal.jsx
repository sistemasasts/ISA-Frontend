...
class ResponderPrincipal extends Component {
    ...
    async componentDidMount() {
        const solicitudes_data = await SolicitudEnsayoService.listarTodosPorResponder();
        this.setState({ solicitudes: solicitudes_data });
    }

    redirigirSolicitudEdicion(idSolcicitud) {
        history.push(`/quality-development_solicitudse_procesar_solicitud/${idSolcicitud}`);
    }
    ...
    render() {
        ...
        return (
            <div className="card card-w-title">
                ...
                <h3><strong>SOLICITUD DE ENSAYOS PROCESAR</strong></h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(ResponderPrincipal);
