...
import "../../site.css";
import { determinarColor, determinarColorPrioridad, determinarColorTipoAprobacion } from './ClasesUtilidades';
...
class PrincipalSE extends Component {
    ...
    constructor() {
        ...
        this.bodyTemplatePrioridad = this.bodyTemplatePrioridad.bind(this);
    }
        ...
        return (
            <div className="card card-w-title">
                ...
                <DataTable value={this.state.solicitudes} paginator={true} rows={15} header={header} responsive={true} scrollable={true}
                    ...
                    <Column field="detalleMaterial" header="Material" sortable={true} style={{ textAlign: 'center', width: '10em' }} />
