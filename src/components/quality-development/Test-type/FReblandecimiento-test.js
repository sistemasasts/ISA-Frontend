...
class ReblandecimientoForm extends Component {
    ...
    inputDateEditor(props, field) {
        ...
        return <div className='p-fluid'><Calendar id={props.rowIndex} dateFormat="yy/mm/dd" value={this.state.testReblandecimiento[props.rowIndex][field]} locale={es} showTime={true} onChange={(e) => this.onEditorValueChange(props, e.value)} /></div>
    }
