...
var that;
class AWeightForm extends Component {
    constructor() {
        super();
        this.state = {
            testPesoAreaData: [
    ...
    inputDateEditor(props, field) {
        ...
        return <div className='p-fluid'><Calendar appendTo={document.body} id={props.rowIndex} dateFormat="yy/mm/dd" value={this.state.testPesoAreaData[props.rowIndex][field]} locale={es} showTime={true} onChange={(e) => this.onEditorValueChange(props, e.value)} /></div>
    }
...
export default connect(mapStateToProps)(AWeightForm)
